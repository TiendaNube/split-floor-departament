...
public class LettersAndNumbersDigitsWithOneSpaceRule implements SplitAddressRule {

    @Override
    public boolean hasCondition(String floor) {
        return matchWithRegex(floor, LETTERS_AND_DIGITS_WITH_ONE_SPACE.getRegex());
    }
